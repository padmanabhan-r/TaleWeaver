            ...
            <div className="flex flex-col items-center gap-2" style={{ minHeight: "80px" }}>
              {sessionState === "ended" ? (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center gap-2">
                  <button onClick={() => setShowRecap(true)} className="px-6 py-2 rounded-full bg-primary text-primary-foreground font-body text-sm font-semibold hover:brightness-110 transition-all">
                    📖 See our story!
                  </button>
